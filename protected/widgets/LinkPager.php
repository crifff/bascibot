...
{
	const CSS_FIRST_PAGE='pure-button first';
	const CSS_LAST_PAGE='pure-button last';
	const CSS_PREVIOUS_PAGE='pure-button prev';
	const CSS_NEXT_PAGE='pure-button next';
	const CSS_INTERNAL_PAGE='pure-button';
	const CSS_HIDDEN_PAGE='hidden';
	const CSS_SELECTED_PAGE='pure-button-active';
	...
	public function init()
	{
		...
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='pure-paginator';
	}
